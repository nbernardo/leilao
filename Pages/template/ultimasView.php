			...
			<div class="row">
				<div class="col">
					...
					<div class="reviews_title_container">
						<h3 class="reviews_title">Últimas visualizações</h3>
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									...
									<div class="review_content">
										...
										<div class="review_text"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas fermentum lAKZ reet.</p></div>
									</div>
								</div>
							</div>
