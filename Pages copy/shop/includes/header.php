			...
			<div class="container">
				<div class="pull-left">
					...
					<div class="header-search">
						<form>
							<input class="input search-input" type="text" placeholder="Enter a sua Busca" style="padding-left:230px;">
							<select class="input search-categories" style="width:225px">
				...
				<div class="pull-right">
					<ul class="header-btns">
						...
						<li class="header-account dropdown default-dropdown">
							...
							<a href="/e-commerce/Pages/shop/cliente/login.php" class="text-uppercase">Entrar</a> / <a href="#" class="text-uppercase">Join</a>
							<ul class="custom-menu">
								<li><a href="/e-commerce/Pages/shop/cliente/conta.php"><i class="fa fa-user-o"></i> Minha Conta</a></li>
								<li><a href="#"><i class="fa fa-heart-o"></i> My Wishlist</a></li>
								<li><a href="#"><i class="fa fa-exchange"></i> Compare</a></li>
								<li><a href="#"><i class="fa fa-check"></i> Checkout</a></li>
								<li><a href="/e-commerce/Pages/shop/cliente/login.php"><i class="fa fa-unlock-alt"></i> Entrar</a></li>
